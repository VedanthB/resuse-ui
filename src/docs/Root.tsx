    ...
    <div className='flex h-screen w-full flex-col overflow-hidden'>
      <Navbar fluid>
        <div className='flex items-center'>
          ...
          />
          <span className='text-xl font-semibold dark:text-white'>reuseUI React Components</span>
        </div>
        <div className='flex items-center gap-2'>
          <a
            ...
            href='https://reuseui-storybook.vercel.app/?path=/story/components-carousel--default'
            title='Storybook'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            className='cursor-pointer rounded-lg p-2.5 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700'
            href='https://github.com/VedanthB/resuse-ui'
