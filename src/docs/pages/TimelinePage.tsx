...
const TimelinePage: FC = () => {
  const pageContent: PageContent = {
    title: 'Timeline',
    description:
      'Use the timeline component from ReuseUI React to display a list of items and events in a chronological order based on multiples styles, colors and layouts',
