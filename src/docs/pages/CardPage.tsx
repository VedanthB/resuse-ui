...
const CardPage: FC = () => {
  ...
  const examples: CodeExample[] = [
        ...
        <div className='max-w-sm'>
          <Card>
            <div className='flex justify-end px-4 pt-4'>
              {/* TODO: add dropdown comp and then add this */}
    ...
    //               {/* TODO: add label, text input , checkbox and button comp and then add this */}
    //               <Label htmlFor='email1' value='Your email' />
    //             </div>
    //             <TextInput id='email1' type='email' placeholder='name@ReuseUI.com' required />
    //           </div>
    //           <div>
    //             <div className='mb-2 block'>
      ...
      code: (
        <Card>
          ...
          <p className='mb-5 text-base text-gray-500 dark:text-gray-400 sm:text-lg'>
            Stay up to date and move work forward with ReuseUI on iOS & Android. Download the app
            today.
          </p>
