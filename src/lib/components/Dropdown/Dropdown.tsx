...
import type { ReuseUIDropdownDividerTheme } from './DropdownDivider';
import { DropdownDivider } from './DropdownDivider';
import type { ReuseUIDropdownHeaderTheme } from './DropdownHeader';
import { DropdownHeader } from './DropdownHeader';
import type { ReuseUIDropdownItemTheme } from './DropdownItem';
import { DropdownItem } from './DropdownItem';
import { uuid } from '~/lib/helpers/uuid';

export interface ReuseUIDropdownFloatingTheme
  extends ReuseUIFloatingTheme,
    ReuseUIDropdownDividerTheme,
    ReuseUIDropdownHeaderTheme {
  item: ReuseUIDropdownItemTheme;
}

export interface ReuseUIDropdownTheme {
  floating: ReuseUIDropdownFloatingTheme;
  content: string;
...
export interface DropdownProps
  ...
  inline?: boolean;
  label: ReactNode;
  theme?: DeepPartial<ReuseUIDropdownTheme>;
}
