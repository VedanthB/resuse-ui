...
const TestBreadcrumb: FC = () => (
  <Breadcrumb aria-label='test label'>
    ...
    <Breadcrumb.Item icon={HiHome}>ReuseUI React</Breadcrumb.Item>
  </Breadcrumb>
);
...
const contents = () => screen.getAllByTestId('ReuseUI-breadcrumb-item');
...
describe('Components / Breadcrumb', () => {
  describe('A11y', () => {
    ...
    it('should contain a `role="listitem"` for each `Breadcrumb.Item`', () => {
      ...
      expect(items()[2]).toHaveTextContent('ReuseUI React');
    });
